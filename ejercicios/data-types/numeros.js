...
var suma = numOne + numTwo;

console.log(suma);

// 2. Utilizando la variable suma, creada en el ejercicio anterior, encuentra el valor resultante de dividir (suma) 
// entre la variable (dividendo) y asígnalo a una variable llamada cociente.
var dividendo = 4;

var cociente = suma / dividendo;
console.log(dividendo);


// 3. Utiliza la variable (cociente) y encuentra el resultado de elevar este valor al valor de la variable (exponente) 
// y asignalo a una variable llamada (potencia).
var exponente = 3;
